#ifdef ARDUINO
//============================================================================
// Name        : SensorWLED_HD44780LCD16x2.ino
...
HD44780LCD lcd( 2, 16, 0x27); // instantiate an LCD object
...
void update2x16Display(void) {
	...
	lcd.PCF8574_LCDSendString("Peak : ");
	lcd.PCF8574_LCDGOTO(LCDLineNumberOne, 8);
	lcd.print(pk_mv_value);

	lcd.PCF8574_LCDGOTO(LCDLineNumberTwo , 0);
	lcd.PCF8574_LCDSendString("Input: ");
	lcd.PCF8574_LCDGOTO(LCDLineNumberTwo, 8);
	lcd.print(mv_value);
